    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-280 px-6">
        ...
        >
          <Link
            href="#download"
            className="inline-flex items-center gap-2 rounded-lg bg-(--color-accent) px-8 py-4 text-base font-bold uppercase tracking-[0.08em] text-(--color-on-accent) transition-all duration-150 hover:-translate-y-0.5 hover:shadow-[0_8px_32px_rgba(184,255,87,0.3)] active:translate-y-0 no-underline"
          >
