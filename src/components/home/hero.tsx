  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(184,255,87,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(184,255,87,0.04) 1px, transparent 1px)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 50% at 50% -20%, #2A3D0C22, transparent)",
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 mx-auto max-w-[1120px] px-6">
        <motion.div
          ...
          className="mb-6"
        >
          <span className="inline-flex items-center rounded-[4px] bg-[var(--color-accent)] px-3 py-1 text-[11px] font-bold uppercase tracking-[0.08em] text-[var(--color-on-accent)]">
            NOW AVAILABLE
          </span>
        </motion.div>

        <h1 className="mb-6 font-[family-name:var(--font-display)] text-[clamp(2.25rem,6vw,3.75rem)] font-extrabold leading-[1.08] tracking-tight text-[var(--color-on-primary)]">
          {words.map((word, i) => (
            <motion.span
              key={i}
          ...
          <motion.span
            ...
            className="inline-block text-[var(--color-dark-text-secondary)]"
        ...
        <motion.p
          ...
          className="mb-8 max-w-[560px] text-lg text-[var(--color-dark-text-secondary)]"
        >
        ...
        >
          <Link
            href="#download"
            className="inline-flex items-center gap-2 rounded-[8px] bg-[var(--color-accent)] px-8 py-4 text-base font-bold uppercase tracking-[0.08em] text-[var(--color-on-accent)] transition-all duration-150 hover:-translate-y-0.5 hover:shadow-[0_8px_32px_rgba(184,255,87,0.3)] active:translate-y-0 no-underline"
          >
