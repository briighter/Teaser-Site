  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1120px] px-6">
        ...
        <p className="mx-auto mb-8 max-w-[480px] text-lg text-[rgba(232,240,227,0.7)]">
